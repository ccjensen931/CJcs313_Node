...
module.exports = {
    ...
    createAccount: function(req, res) {
        bcrypt.hash(req.body.password, saltRounds, function(err, hash) {
            const query = {
                name: 'create-account',
                text: "INSERT INTO users VALUES (nextval('users_s1'), $1, $2, $3, $4, $5, FALSE);",
                values: [req.body.username, hash, req.body.email, req.body.firstName, req.body.lastName]
            };
            ...
            pool.query(query, function(err, result) {
                ...
                res.json({success: createSuccessful});
            });
        });
    }
};